package screens.FSM.WarFSM 
{
	 ...
	 * @author Olivier
	 */
	public class ChooseSkillGeneralState implements IState 
	{
		private var _timeSinceBegin:int;
		private var dispatcher:EventDispatcher;
		private var _view:MovieClip;
		
		public function ChooseSkillGeneralState(view:MovieClip) 
		{
			_view = view;
		}
		...
		public function Init():void
		{
			...
			trace("ChooseSkillGeneralState Init");
		...
		public function End():void
		{
			...
			trace("ChooseSkillGeneralState ended");
